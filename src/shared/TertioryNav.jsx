    ...
    {/* <nav className='navbar navbar-expand-lg navbar-dark bg-red-600 p-1 fixed top-0 left-0 w-full'> */}
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden flex-grow lg:flex lg:justify-around lg:w-full space-x-5">
          ...
          <Dropdown title="Admissions" link="/admissions" classes_title={`text-lg text-white hover:bg-blue-200 py-2 rounded-md px-1 mx-2`} items={[{ name:'Why Admission at CUB?', link:'/admissions/why'}, { name:'Undergraduate Admission', link:'/admissions/undergrad-admission'}, { name:'Postgraduate Admission', link:'/admissions/postgrad-admission'}, { name:'Scholarship', link:'/admissions/scholarship'}, { name:'Credit Transfer', link:'/admissions/credit-transfer'}, { name:'FAQs', link:'/admissions/faq'}]} />
