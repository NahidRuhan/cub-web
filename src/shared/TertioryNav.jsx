    ...
    {/* <nav className='navbar navbar-expand-lg navbar-dark bg-red-600 p-1 fixed top-0 left-0 w-full'> */}
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden flex-grow lg:flex lg:justify-around lg:w-full space-x-5">
          ...
          <Dropdown title="Academics" link="/academics" classes_title={`text-lg text-white hover:bg-blue-200 py-2 rounded-md px-1 mx-2`} items={[{ name:'Schools', link:'/academics/schools'}, { name:'Departments', link:'/academics'}, { name:'Centers And Institution', link:'/academics/center-institutions'}, { name:'Fees And Payments', link:'/academics'}, { name:'Policies And Procedures', link:'/academics'}, { name:'Institutional Quality Assurance Cell (IQAC)', link:'/academics'}]} />
