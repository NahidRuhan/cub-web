...
const TertioryNav = () => {
  ...
  return (
    <nav
      className={`${
        isSticky
          ? "bg-logoRed p-1 fixed top-0 left-0 w-full z-50"
          : "bg-logoRed p-1 z-50"
      }`}
    >
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden flex-grow lg:flex lg:justify-around lg:w-full space-x-5">
          <Dropdown
            ...
            classes_title={`text-lg text-white hover:bg-white hover:text-logoRed hover:underline py-2 rounded-md px-1 mx-2`}
            items={[
              { name: "Vision Mission", link: "/about-us/vision-mission" },
              {
                name: "Leadership And Administration",
                link: "/about-us/leadership-administration",
              },
              {
                name: "Message from Chairman",
                link: "/about-us/chairman-message",
              },
              {
                name: "Message from Vice Chancellor",
                link: "/about-us/vc-message",
              },
              {
                name: "Message from Pro Vice Chancellor",
                link: "/about-us/provc-message",
              },
              { name: "Collaboration", link: "/about-us/collaboration" },
              {
                name: "Awards And Achievements",
                link: "/about-us/awards-achievements",
              },
              { name: "Permanent Campus", link: "/about-us/permanent-campus" },
            ]}
          />
          <Dropdown
            title="Academics"
            ...
            classes_title={`text-lg text-white hover:bg-white hover:text-logoRed hover:underline py-2 rounded-md px-1 mx-2`}
            items={[
              { name: "Schools", link: "/academics/schools" },
              { name: "Departments", link: "/academics/departments" },
              {
                name: "Centers And Institution",
                link: "/academics/center-institutions",
              },
            ]}
          />
          <Dropdown
            ...
            classes_title={`text-lg text-white hover:bg-white hover:text-logoRed hover:underline py-2 rounded-md px-1 mx-2`}
            items={[
              { name: "Why Admission at CUB?", link: "/admissions/why" },
              { name: "Scholarship", link: "/admissions/scholarship" },
              {
                name: "Tuition Fees and Policy",
        ...
        {isScrolled && (
          <button
            ...
            className="btn hover:bg-green-900 hover:text-white bg-white text-black pl-5 "
          >
            {" "}
            Apply Now
          </button>
        ...
        {mobileMenuOpen && (
          <div
            ...
            className="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform bg-logoRed"
          >
            <button
            ...
            <div className="py-4 overflow-y-auto">
              <ul className="space-y-2 font-medium">
                <MobileMenuItem
                  ...
                  title="About Us"
                  link="/about-us/vision-mission"
                  classes_title={`text-lg text-white hover:bg-blue-200 py-2 rounded-md px-1 mx-2`}
                  items={[
                    {
                      name: "Vision Mission",
                      link: "/about-us/vision-mission",
                    ...
                    },
                    {
                      ...
                      link: "/about-us/permanent-campus",
                    },
                  ]}
                />
                <MobileMenuItem
  ...
  return (
    <div className="group relative">
      ...
      >
        <a href={link}>
          <button
            className={` text-white hover:bg-blue-200 rounded-md z-45`}
        ...
        {has_children && (
          <button
            className={`text-xl text-white hover:bg-blue-200 py-2 rounded-md px-5 mx-5 z-50`}
          >
            +
          </button>
        )}
      ...
      <div className="absolute hidden group-hover:bg-[#F5F5F5] group-hover:rounded text-black group-hover:block z-50">
        {items.map((item, index) => (
          <a
            key={index}
            href={item.link}
            className="block px-4 py-2  hover:text-logoRed"
          >
            {item.name}
          </a>
        ))}
