...
const Awards = () => {
  ...
  <h1 className="text-3xl">Awards And Achievements</h1>
      ...
      <div className="mx-3 lg:mx-auto lg:max-w-4xl xl:max-w-7xl 2xl:max-w-7xl py-10 flex flex-col items-center">
        <img className="w-3/4" src="https://canadianuv.netlify.app/Achievements/img%20(1).jpg" alt="" />
        <img className="w-3/4" src="https://canadianuv.netlify.app/Achievements/img%20(2).jpg" alt="" />
        <img className="w-3/4" src="https://canadianuv.netlify.app/Achievements/img%20(3).jpg" alt="" />
        <img className="w-3/4" src="https://canadianuv.netlify.app/Achievements/img%20(4).jpg" alt="" />
        <img className="w-3/4" src="https://canadianuv.netlify.app/Achievements/img%20(5).jpg" alt="" />
        <img className="w-3/4" src="https://canadianuv.netlify.app/Achievements/img%20(6).jpg" alt="" />
