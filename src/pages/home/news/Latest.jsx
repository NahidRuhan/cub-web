...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
      ...
      <div className="p-5 bg-slate-100 shadow-xl relative overflow-hidden h-[600px]">
        <div className="flex flex-col gap-2">
          ...
          <p className="font-normal text-lg font-nunito">The CUB and the Texas A&M University Lab have signed a MoU to promote collaboration in the areas of faculty and student exchange, joint research</p>
        </div>
      </div>
      ...
      <div className="p-5 bg-slate-100 shadow-xl relative overflow-hidden h-[600px]">
        <div className="flex flex-col gap-2">
          ...
          <span className="text-sm">2023-11-26</span>
          <p className="font-normal text-lg font-nunito">কানাডিয়ান ইউনিভার্সিটি অব বাংলাদেশের পক্ষ থেকে ২০২৩ সালের এইচএসসি ও সমমান পরীক্ষায় উত্তীর্ণ কৃতি শিক্ষার্থীদের বর্ণাঢ্য সংবর্ধনা দেওয়া হয়েছে</p>
        </div>
      </div>
      ...
      <div className="p-5 bg-slate-100 shadow-xl relative overflow-hidden h-[600px]">
        <div className="flex flex-col gap-2">
          ...
          <span className="text-sm">2023-11-26</span>
          <p className="font-normal text-lg font-nunito">সভায় সভাপতিত্ব করেন ভারপ্রাপ্ত উপাচার্য প্রফেসর ড. গিয়াস উ আহসান। প্রধান অতিথি ছিলেন বোর্ড অব ট্রা‌স্টিজ এর চেয়ারম‌্যান ড. চৌধুরী নাফিজ সরাফাত।</p>
        </div>
      </div>
      ...
      <div className="p-5 bg-slate-100 shadow-xl relative overflow-hidden h-[600px]">
        <div className="flex flex-col gap-2">
          ...
          <span className="text-sm">2023-11-26</span>
          <p className="font-normal text-lg font-nunito">The Canadian University of Bangladesh (CUB) and Dhaka Stock Exchange, jointly hosted a seminar on Corporate Sustainability on December 3, 2023, at CUB auditorium</p>
        </div>
      </div>
